...
This directory contains non-regression tests for the Morpho plugin.
...
The Etheruem binaries should be compiled with the flag CAL_TEST_KEY=1. The first method is to use the Ledger VSCode extension to automatically manage dependencies
...
For example in the [plugin-Morpho CI](https://github.com/LedgerHQ/app-plugin-morpho/actions/workflows/build_and_functional_tests.yml).

The plugin morpho app comes with functional tests 
